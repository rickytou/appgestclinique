      ...
      <div class="app-wrapper">
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
          <div class="container-xl">
            ...
            <h1 class="app-page-title">Questions fr&eacute;quemment pos&eacute;es</h1>
           <div class="app-card app-card-accordion shadow-sm mb-4">
              <div class="app-card-header p-4 pb-2  border-0">
                 <h4 class="app-card-title">Patient</h4>
              </div><!--//app-card-header-->
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="faq1-heading-1">
                      <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse"  data-bs-target="#faq1-1" aria-expanded="false" aria-controls="faq1-1">
                        Pourquoi le systeme affiche, format numero telephone incorrect?
                      </button>
                    </h2>
                    <div id="faq1-1" class="accordion-collapse collapse border-0" aria-labelledby="faq1-heading-1">
                        <div class="accordion-body text-start p4">
                            Le numero de telephone doit avoir 10 chiffres, il ne doit pas y avoir d'espace, de caracteres speciaux, de lettres alphanumeriques. 
                        </div>
                    </div>
                </div><!--//accordion-item-->  
...
<div class="app-card app-card-accordion shadow-sm mb-4">
  <div class="app-card-header p-3">
     <h4 class="app-card-title">Rendez-vous</h4>
  </div><!--//app-card-header-->
  <div class="app-card-body p-4 pt-0">
    <div id="faq2-accordion" class="faq2-accordion faq-accordion accordion">
        ...
        <h2 class="accordion-header" id="faq2-heading-1">
          <button class="accordion-button btn btn-link" type="button" data-bs-toggle="collapse"  data-bs-target="#faq2-1" aria-expanded="false" aria-controls="faq2-1">
            Pourquoi, je ne peux pas supprimerun rendez-vous ?
          </button>
        </h2>
        <div id="faq2-1" class="accordion-collapse collapse border-0" aria-labelledby="faq2-heading-1">
            <div class="accordion-body text-start p4">
                Un rendez-vous annul&eacute; est passe d'un statut "en cours" au statut "annule" mais il n'est pas supprime dans le systeme pour des raisons de statitistiques
            </div>
        </div>
    </div><!--//accordion-item-->
    ...
    <path d="M6.5 14a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2h-1a1 1 0 0 1-1-1z"/>
                        ...
                        <div class="col-auto">
                          <h4 class="app-card-title">Besoin plus d'aide ?</h4>
                        </div><!--//col-->
                      </div><!--//row-->
                  </div><!--//app-card-header-->
                  <div class="app-card-body px-4">
                    ...
                    <ul class="list-unstyled">
                      <li><strong>Tel:</strong> 514-5121112</li>
                      <li><strong>Email:</strong> <a href="#">support@cliniquejeannotcadet.com</a></li>
                    </ul>
                  </div><!--//app-card-body-->
                  <div class="app-card-footer p-4 mt-auto">
                   <a class="btn app-btn-secondary" href="#">Contact web developper</a>
                  </div><!--//app-card-footer-->
              </div><!--//app-card-->
            </div><!--//col-->
            {{-- <div class="col-12 col-md-6">
